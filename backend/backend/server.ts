...
app.get('/api/properties', (req, res) => {
  ...
  fs.readFile(filePath, 'utf8', (err, data) => {
    if (err) {
      console.error("Erreur lors de la lecture du fichier:", err); // Affiche l'erreur dans la console pour le débogage
    ...
    try {
      ...
      console.error("Erreur de parsing JSON:", parseError); // Affiche l'erreur de parsing dans la console
